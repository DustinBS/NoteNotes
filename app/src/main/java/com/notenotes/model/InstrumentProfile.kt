...
data class InstrumentProfile(
    ...
    val clefSign: String = "G",
    val clefLine: Int = 2,
    val clefOctaveChange: Int = 0  // -1 for treble 8vb (guitar), 0 for normal
) {
    companion object {
        val PIANO = InstrumentProfile("piano", "Piano", 0)
        val GUITAR = InstrumentProfile("guitar", "Guitar", 12, clefOctaveChange = -1)  // treble 8vb, written octave above sounding
        ...
        val BASS_GUITAR = InstrumentProfile("bass_guitar", "Bass Guitar", 12, clefOctaveChange = -1)  // treble 8vb
